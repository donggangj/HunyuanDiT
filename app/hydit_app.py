...
def infer(prompt, negative_prompt, seed, cfg_scale, infer_steps, oriW, oriH, sampler, size, enhance):
            ...
            with gr.Column():
                ...
                with gr.Accordion(strings["accordion"], open=False):
                    ...
                    with gr.Row():
                        ...
                        cfg_scale = gr.Slider(label=strings["cfg"], minimum=1.0, maximum=16.0, value=6.0, step=1)
                        oriW = gr.Number(
                            label=strings["width cond"],
                            minimum=1024,
                            maximum=4096,
                            value=1024,
                            step=64,
...
if __name__ == "__main__":
    interface = ui()
    interface.launch(server_name="0.0.0.0", server_port=6666, share=True)

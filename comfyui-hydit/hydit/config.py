...
def get_args(default_args=None):
    ...
    # Basic
    parser_hunyuan.add_argument(
        "--prompt",
        type=str,
        default="现实主义风格，画面主要描述一个巴洛克风格的花瓶，带有金色的装饰边框，花瓶上盛开着各种色彩鲜艳的花，白色背景",
    ...
    parser_hunyuan.add_argument(
        "--text-states-dim-t5", type=int, default=2048, help="Hidden size of CLIP text encoder."
    )
    ...
    parser_hunyuan.add_argument(
        "--sampler", type=str, choices=SAMPLER_FACTORY, default="ddim", help="Diffusion sampler"
    )
